...
@section('content')
 <div class="px-5">
          ...
          <div class="flex flex-col gap-4 mt-[10px]">
            <div
              ...
              <div class="w-[128px] h-[88px]">
                <img src="{{ asset('storage/' . $transactionDetail->product->image) }}" class="w-full object-cover rounded-[8px]" alt="icon">
              </div>
  ...
  <a href="{{ route('index', $store->username) }}" class="flex justify-center rounded-full p-[14px_28px] bg-[#FF801A] font-normal text-white mt-6">
    See More Menu
  </a>
 </div>
@endsection
