  ...
  <div id="Items" class="relative flex flex-col px-5 mt-[20px]">
    <div class="flex flex-col gap-4 mt-[10px]">
      @foreach ($store->products as $product)
        <div
          class="cart-item flex gap-4 flex-col rounded-[8px] border border-[#F1F2F6] p-[12px]  bg-white hover:bg-[#FFF7F0] hover:border-[1px] hover:border-[#F3AF00] transition-all duration-300"
          data-id="{{ $product->id }}">
      ...
      <div class="w-full flex flex-col rounded-[8px] border border-[#F1F2F6] p-5 gap-6 bg-white mt-6">
        <div id="InputContainer" class="flex flex-col gap-[18px]">
          ...
          <div class="flex w-full gap-3">
            <div
              class="flex items-center gap-2 rounded-[16px] p-[18px_28px] bg-[#F1F2F6] font-normal text-[#353535] w-full hover:cursor-pointer"
            ...
            <div
              ...
              <input type="radio" name="payment_method" id="midtrans" class="peer hidden" value="midtrans" required>
